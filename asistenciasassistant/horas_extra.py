...
st.subheader("📂 Archivos del mes anterior")
st.markdown("Subí los archivos correspondientes al mes anterior. En caso de tener dos liquidaciones, sube ambos juntos.")
...
st.subheader("📂 Archivos del mes actual")
st.markdown("Subí los archivos correspondientes al mes actual. En caso de tener dos liquidaciones, sube ambos juntos.")
...
if archivos_1 and archivos_2:
    ...
    st.download_button(
        label="📂 Descargar planilla de horas extras por persona",
    ...
    st.download_button(
      label="📂 Descargar planilla de horas extras por oficina para el mes actual",
